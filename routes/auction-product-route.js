...
const { createAuctionProduct, readAuctionProduct, readAuctionProductWithUUID, readAuctionProductOldToNew, readAuctionProductNewToOld, readAuctionProductCheapToExpensive,
        readAuctionProductExpensiveToCheap, readAuction3Product, updateBid, updateAuctionProduct, updateAuctionProductImage, updateAuctionStatus, deleteAuctionProduct, readAuctionProductAll
...
router.patch('/update-auction-product-image/:uuid', updateAuctionProductImage)
